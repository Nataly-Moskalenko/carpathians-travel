      ...
      <div className="p-6">
        <div className="md:flex gap-6">
          ...
          <div className="w-[292px] pt-6">
            <p className="mb-6 text-[14px] font-extralight leading-[20px] md:text-[16px] lg:text-[18px] leading-[24px]">
        ...
        <div className="md:flex mt-[72px] flex-row-reverse justify-between">
          <div>
          ...
          <p className="text-[14px] font-extralight leading-[20px] md:text-[16px] lg:text-[18px] leading-[24px] w-[605px]">
