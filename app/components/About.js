    ...
    >
      <div className="p:0 lg:p-6 max-w-[1440px] lg:mx-auto">
        ...
        <div className="md:flex mt-[40px] md:mt-[64px] lg:mt-[72px] flex-row-reverse justify-between relative">
          <div className="mb-[40px] md:mb-0 w-[180px] md:w-[221px] ml-auto md:absolute md:left-8 md:bottom-[136px] lg:relative lg:left-0 lg:bottom-0 lg:w-[296px] ">
            <p className="text-[14px] font-normal leading-[20px] md:text-[16px] lg:text-[18px] lg:leading-[24px] uppercase">
              From vacationers
            </p>           
            <p className="pl-5 md:pl-[40px] lg:pl-[92px] text-[14px] font-normal leading-[20px] md:text-[16px] lg:text-[18px] lg:leading-[24px] uppercase">
              to active travelers
            </p>           
            <p className="text-[14px] font-extralight leading-[20px] md:text-[16px] lg:text-[18px] lg:leading-[24px] tracking-[-0.14px] md:tracking-[0.32px] lg:tracking-[2.16px]">
              we have a tour for everyone.
            </p>
          </div>
          <p className="text-[14px] font-extralight leading-[20px] md:text-[16px] lg:text-[18px] lg:leading-[24px] min-w-[280px] max-w-[440px] md:max-w-[463px] lg:max-w-[605px]">
